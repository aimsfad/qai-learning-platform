...
def validate_non_destructive_integration() -> None:
    ...
    require(
        is_v6201 or is_v620 or is_v6191 or is_v6190 or is_v6189 or 'APP_VERSION = "v6.18.8-teacher-workspace-screenshot-polish"' in db,
    ...
    if is_v6201 or is_v620 or is_v6191 or is_v6190 or is_v6189:
        for path in (
