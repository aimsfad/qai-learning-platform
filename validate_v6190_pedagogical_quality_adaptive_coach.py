...
def validate_static_integration() -> None:
    ...
    require(any(v in db for v in ('APP_VERSION = "v6.20.1-responsive-visual-polish"', 'APP_VERSION = "v6.20.0-published-course-runtime"', 'APP_VERSION = "v6.19.1-learner-evidence-misconception-tracing"', 'APP_VERSION = "v6.19.0-pedagogical-quality-adaptive-coach"')), "V6.19.0+ app version missing")
    for column in (
