...
checks = {
    'version': ('APP_VERSION = "v6.20.21-published-course-entry-routing"' in db or 'APP_VERSION = "v6.20.20-learner-account-compat-ui-density"' in db or 'APP_VERSION = "v6.20.19-course-enrollment-baseline-gate"' in db),
