...
def validate_integration_contracts() -> None:
    ...
    require(any(v in db for v in ('APP_VERSION = "v6.20.0-published-course-runtime"', 'APP_VERSION = "v6.19.1-learner-evidence-misconception-tracing"')), "V6.19.1+ app version missing")
    for token in [
