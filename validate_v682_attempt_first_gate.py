...
assert any(v in db for v in ('APP_VERSION = "v6.8.2-attempt-first-gate"', 'APP_VERSION = "v6.18.6-unified-premium-platform-design"', 'APP_VERSION = "v6.10-gemini-file-analyzer-router"'))
