...
assert 'APP_VERSION = "v6.18.2-blueprint-editor-runtime-and-ui-polish"' in db_source or 'APP_VERSION = "v6.17.3-blueprint-action-feedback-hotfix"' in db_source
...
assert 'created_bundle = lesson_blueprint_engine.generate_and_persist(' in ui
assert 'st.success(success_label)' in ui
