...
assert any(v in db_source for v in ('APP_VERSION = \"v6.18.4-simple-teacher-journey\"', 'APP_VERSION = \"v6.18.3-guided-blueprint-lesson-production\"', 'APP_VERSION = \"v6.18.2-blueprint-editor-runtime-and-ui-polish\"', 'APP_VERSION = \"v6.17.3-blueprint-action-feedback-hotfix\"'))
