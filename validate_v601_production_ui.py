...
def main() -> None:
    ...
    require("v601-engine-badge" in ui or "v61-visual-label" in ui, "The hero-safe engine label is missing")
    ...
    require("APP_VERSION = \"v6." in db, "Instrumented version was not updated")
