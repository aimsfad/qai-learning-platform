...
def validate_static_contracts() -> None:
    ...
    require(any(v in db_source for v in ('APP_VERSION = "v6.20.3-mobile-public-shell"', 'APP_VERSION = "v6.20.1-responsive-visual-polish"', 'APP_VERSION = "v6.20.0-published-course-runtime"')), "V6.20+ app version missing")
    for table in (
