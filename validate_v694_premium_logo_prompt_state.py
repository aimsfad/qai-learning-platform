...
def main() -> None:
    ...
    require(any(v in db for v in ('APP_VERSION = "v6.9.4-premium-logo-prompt-state"', 'APP_VERSION = "v6.10-gemini-file-analyzer-router"', 'APP_VERSION = "v6.11-educational-content-builder"', 'APP_VERSION = "v6.11.1-prompt-budget-rtl-hotfix"', 'APP_VERSION = "v6.12-research-augmented-content-builder"', 'APP_VERSION = "v6.13-evidence-synthesis-foundation"', 'APP_VERSION = "v6.13.1-provider-quota-resilience"')), "Application version is not V6.9.4+")
