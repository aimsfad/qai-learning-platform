...
def validate_ui_contract() -> None:
    ...
    assert any(v in db_text for v in ('APP_VERSION = "v6.9.3-save-prompt-hotfix"', 'APP_VERSION = "v6.9.4-premium-logo-prompt-state"', 'APP_VERSION = "v6.10-gemini-file-analyzer-router"', 'APP_VERSION = "v6.11-educational-content-builder"', 'APP_VERSION = "v6.11.1-prompt-budget-rtl-hotfix"'))
