...
if not any(v in db_text for v in ('APP_VERSION = "v6.10.1-ai-tutor-state-hotfix"', 'APP_VERSION = "v6.11-educational-content-builder"', 'APP_VERSION = "v6.11.1-prompt-budget-rtl-hotfix"', 'APP_VERSION = "v6.12-research-augmented-content-builder"', 'APP_VERSION = "v6.13-evidence-synthesis-foundation"')):
