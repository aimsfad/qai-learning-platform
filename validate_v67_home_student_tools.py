...
def main() -> None:
    ...
    require(any(v in db for v in ('APP_VERSION = "v6.18.6-unified-premium-platform-design"', 'APP_VERSION = "v6.7-home-hero-student-tools"')), "Application version was not updated.")
