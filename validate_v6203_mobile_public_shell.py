...
def main() -> None:
    ...
    require('key="v6203_mobile_public_header"' in ui, "dedicated mobile public header missing")
    require("st.popover(" in ui and 'icon=":material/menu:"' in ui, "mobile navigation is not a native compact menu")
    require('key="v6203_mobile_language"' in ui, "mobile language selector missing")
    require('key="v6203_mobile_start"' in ui, "mobile primary CTA missing")
    ...
    require('APP_VERSION = "v6.20.3-mobile-public-shell"' in db, "V6.20.3 app version missing")
